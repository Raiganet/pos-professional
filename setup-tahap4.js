...
console.log('\n🚀 POS PROFESSIONAL - SETUP TAHAP 4 (MANAJEMEN STOK)\n');
console.log('======================================================\n');

// ==========================================
// 1. API ROUTES - STOCK MOVEMENTS
// ==========================================
console.log('🔌 Membuat API Routes Manajemen Stok...');

createFile(path.join(ROOT_DIR, 'app/api/stock/route.ts'), `
...
// ==========================================
// 2. HALAMAN MANAJEMEN STOK
// ==========================================
console.log('\n📦 Membuat halaman Manajemen Stok...');

createFile(path.join(ROOT_DIR, 'app/(dashboard)/stok/page.tsx'), `
'use client';
...
if (fs.existsSync(sidebarPath)) {
  ...
  if (!content.includes('/stok')) {
    // Pastikan menu Stok ada
    if (!content.includes("label: 'Stok'")) {
       const insertPoint = "{ label: 'Laporan', icon: BarChart3, href: '/laporan' },";
       content = content.replace(insertPoint, "{ label: 'Stok', icon: Warehouse, href: '/stok' },\n  " + insertPoint);
       fs.writeFileSync(sidebarPath, content);
       console.log('✅ Updated: Sidebar menu Stok');
    }
  }
}
...
// ==========================================
console.log('\n======================================================');
console.log('✅ TAHAP 4 SELESAI!');
console.log('======================================================\n');
console.log('Fitur Manajemen Stok siap digunakan:\n');
console.log('   📥 Stock In: Tambah stok dari pembelian/supplier');
console.log('   📤 Stock Out: Kurangi stok (rusak/hilang/sample)');
console.log('   🔄 Opname: Sesuaikan stok fisik dengan sistem');
console.log('   📜 Riwayat: Lihat log semua perubahan stok');
console.log('   ⚠️  Alert: Notifikasi otomatis jika stok menipis\n');
console.log('Silakan buka halaman /stok di browser Anda.');